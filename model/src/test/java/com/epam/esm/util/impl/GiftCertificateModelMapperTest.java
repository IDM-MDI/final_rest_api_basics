...
class GiftCertificateModelMapperTest {
    ...
    public static void init() {
        ...
        dto = new GiftCertificateDto(
                ...
                LocalDateTime.of(2000,1, 1,0,5),
                LocalDateTime.of(1,1,1,1,1),
                List.of(new TagDto(1L,"testTag",null,false,"testStatus")),
                false,
                false,
                false,
                "testStatus");
        entityList = List.of(new GiftCertificate(
                ...
                List.of(new Tag(2L,"testTag2",null,"testStatus")),
                null,
                null,
                null,
                null,
                ...
                new GiftCertificate(
                        ...
                        List.of(new Tag(3L,"testTag3",null,"testStatus")),
                        null,
                        null,
                        null,
                        null,
                ...
                new GiftCertificate(
                        ...
                        List.of(new Tag(4L,"testTag4",null,"testStatus")),
                        null,
                        null,
                        null,
                        null,
        ...
        dtoList = List.of(new GiftCertificateDto(
                        ...
                        LocalDateTime.of(2000,1, 1,0,5),
                        LocalDateTime.of(2,2,2,2,2),
                        List.of(new TagDto(2L,"testTag2",null,false,"testStatus")),
                        false,
                        false,
                        false,
                        "testStatus"),
                new GiftCertificateDto(
                        ...
                        LocalDateTime.of(2000,1, 1,0,5),
                        LocalDateTime.of(3,3,3,3,3),
                        List.of(new TagDto(3L,"testTag3",null,false,"testStatus")),
                        false,
                        false,
                        false,
                        "testStatus"),
                new GiftCertificateDto(
                        ...
                        LocalDateTime.of(2000,1, 1,0,5),
                        LocalDateTime.of(4,4,4,4,4),
                        List.of(new TagDto(4L,"testTag4",null,false,"testStatus")),
                        false,
                        false,
                        false,
                        "testStatus"
