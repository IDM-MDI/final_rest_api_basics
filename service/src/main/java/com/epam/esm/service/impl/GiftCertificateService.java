...
import com.epam.esm.util.impl.GiftCertificateMapper;
...
public class GiftCertificateService implements CustomService<GiftCertificateDto,Long> {
    ...
    @Autowired
    public GiftCertificateService(GiftCertificateDaoImpl dao, Map<String, List<String>> allColumns, GiftCertificateMapper mapper) {
